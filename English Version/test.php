...
$mailcontent .= "If you have any questions or problems, we are always at your disposal with our free installation service.\n\nFAQ: https://www.kontaktformular.com/en/faq-script-php-contact-form.html";
		...
		if($success){
    		    echo "<br /><p style='display: flex;justify-content: space-between;align-items: flex-start;margin-left:0px;padding-left:0px;'><span style='font-size:15px;font-family: Arial, sans-serif;'>The test form was sent successfully. You should receive an email within the next few seconds. <br /><br /><a style='font-family: Arial, sans-serif;color:black;text-decoration:underline;' href=https://www.kontaktformular.com/en/faq-script-php-contact-form.html#not-receive-email>You did not receive an email? Click here!</a></span></p>";
            }
   ...
   document.getElementsByTagName("BODY")[0].className += " safari";
			...
			<div class="row" id="send">
				<div class="col-sm-8">
						...
						<p style="line-height:21px;">Form to test your server’s mailing function (PHP mail())<br /><br />Please enter your <b>email address</b> here and click on <b>send</b>. You should receive an email within a few seconds. You may then delete this file.</p>
