...
$recipient = "cambodia.admin@successconsultingasia.com";  // Please insert your email address (between the quotation marks)

$yourname = "Success Consulting Asia";  // Please insert your name here (between the quotation marks) It will appear as the sender in the thank-you mail.
...
$thankyou = "email.html";  // Path to thank-you page. You can replace "thankyou.php" with a link or URL. (must begin with "http://www.") You can also use this script to show the linked thank-you page outside the iFrame: https://www.kontaktformular.com/en/embed-form-script-php-contact-form.html#outsideiframe
...
$cfg['Security_code'] = 1;  //  0 = Without security code   1 = With security code

$cfg['Security_question'] = 0;  //  0 = Without security question   1 = With security question

$cfg['Honeypot'] = 1;  //  0 = Without honeypot   1 = With honeypot 
	
$cfg['Time-out'] = 1;  //  Minimum number of seconds between displaying and sending the form	 0 = No time-out
	
$cfg['Click_check'] = 1;  //  0 = Without click check   1 = With click check
